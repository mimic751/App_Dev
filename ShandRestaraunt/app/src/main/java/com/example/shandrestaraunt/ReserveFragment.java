...
// this sets up the calendar view and the reserve button
    @Nullable
    @Override
...
// this part creats random reservation times for the user to choose from becuase I do not have a system in place to 
// actually reserve a table which I believe to be out of scope. This is a UI POC
...
//this creates a dialoge box for the user to enter their details
